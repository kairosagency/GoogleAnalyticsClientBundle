<?php
namespace Kairos\GoogleAnalyticsClientBundle\Exception;
...
class GoogleAnalyticsException extends \Exception
{
     ...
     *
     * @return \Kairos\GoogleAnalyticsClientBundle\Exception\GoogleAnalyticsException The "INVALID ACCESS TOKEN" exception.
     */
     ...
     *
     * @return \Kairos\GoogleAnalyticsClientBundle\Exception\GoogleAnalyticsException The "INVALID PRIVATE KEY FILE" exception.
     */
     ...
     *
     * @return \Kairos\GoogleAnalyticsClientBundle\Exception\GoogleAnalyticsException The "INVALID OPEN SSL EXTENSION" exception.
     */
     ...
     *
     * @return \Kairos\GoogleAnalyticsClientBundle\Exception\GoogleAnalyticsException The "INVALID PKCS 12 FILE" exception.
     */
     ...
     *
     * @return \Kairos\GoogleAnalyticsClientBundle\Exception\GoogleAnalyticsException The "INVALID PKCS 12 FORMAT" exception.
     */
     ...
     *
     * @return \Kairos\GoogleAnalyticsClientBundle\Exception\GoogleAnalyticsException The "INVALID PKCS 12 PKEY" exception.
     */
     ...
     *
     * @return \Kairos\GoogleAnalyticsClientBundle\Exception\GoogleAnalyticsException The "INVALID PKCS 12 SIGNATURE" exception.
     */
     ...
     * @param string $error The error message.
     *
     * @return \Kairos\GoogleAnalyticsClientBundle\Exception\GoogleAnalyticsException The "INVALID QUERY" exception.
     */
